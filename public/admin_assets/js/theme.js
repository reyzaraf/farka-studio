...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    dark_flag = true;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/farkalogo.svg');
    }

    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../assets/images/farkalogo.svg');
    }
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', 'assets/farkalogo.svg');
    }
    if (document.querySelector('.footer-navbar-brand img')) {
      document.querySelector('.footer-navbar-brand img').setAttribute('src', '../assets/images/farkalogo.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '../assets/images/farkalogo.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../assets/images/farkalogo.svg');
    }
    ...
    if (document.querySelector('.footer-navbar-brand img')) {
      document.querySelector('.footer-navbar-brand img').setAttribute('src', 'assets/images/logo-dark.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
