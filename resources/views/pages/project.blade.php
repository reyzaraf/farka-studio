    <section id="project-page" class="page-section bg-white pt-24 md:pt-40 px-6 md:px-20">
        ...
        <div id="back-to-menu-btn" class="md:hidden fixed bottom-6 right-6 bg-black text-white px-4 py-2.5 text-[0.6rem] font-black uppercase tracking-[0.2em] cursor-pointer z-[150] shadow-2xl active:scale-95 transition-all" onclick="scrollToProjectMenu()">
            Back to Menu
        </div>
            ...
            <div class="md:col-span-8 relative h-auto md:h-[calc(100vh-25vh)] mt-6 md:mt-0">
                ...
                <div class="opacity-0 transition-opacity duration-500 flex flex-col md:flex-row gap-6 md:gap-10 h-full" id="project-detail-container">
                    ...
                    <div class="w-full md:w-1/3 pt-0 md:pt-4 h-fit border-b-2 border-gray-100 pb-6 md:border-0 md:pb-0 order-first md:order-last">
                        ...
                        <div id="det-architect" class="text-sm font-bold uppercase mt-1"></div>
                        <div class="text-[0.65rem] font-black text-gray-400 uppercase mt-4 md:mt-6 tracking-widest">Floor Area</div>
                        <div id="det-floor" class="text-sm font-bold uppercase mt-1"></div>
                        <div class="text-[0.65rem] font-black text-gray-400 uppercase mt-4 md:mt-6 tracking-widest">Site Area</div>
                        <div id="det-site" class="text-sm font-bold uppercase mt-1"></div>
                        <div class="text-[0.65rem] font-black text-gray-400 uppercase mt-4 md:mt-6 tracking-widest">Number of Stories</div>
                        <div id="det-stories" class="text-sm font-bold uppercase mt-1"></div>
                        <div class="text-[0.65rem] font-black text-gray-400 uppercase mt-4 md:mt-6 tracking-widest">Location</div>
                        <div id="det-location" class="text-sm font-bold uppercase mt-1"></div>
                    </div>
                </div>
            </div>
        </div>
