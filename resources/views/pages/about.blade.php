    <section id="about-page" class="page-section bg-white pt-24 md:pt-40 px-6 md:px-20">
        ...
        <div class="h-[calc(100vh-25vh)] md:h-full w-full overflow-y-auto scroll-container pb-32">
            ...
            <div class="w-full h-[40vh] md:h-[60vh] mb-20 md:mb-32 relative">
                ...
                <div class="absolute bottom-4 right-6 text-white font-bold tracking-tight text-[0.6rem] md:text-xs opacity-70 bg-black/30 px-2 py-1 rounded">Farka Studio Collective, 2026</div>
            </div>

            <div class="max-w-6xl mx-auto">
                <h3 class="text-xl md:text-2xl font-black mb-8 md:mb-12 tracking-tight text-center md:text-left">Key People</h3>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
                    ...
                    <div class="group cursor-pointer text-center md:text-left">
                        ...
                        <h4 class="font-black tracking-tight text-sm md:text-lg">{{ $person->name }}</h4>
                        <p class="text-[0.65rem] md:text-xs text-gray-400 tracking-tight mt-1 font-bold">{{ $person->role }}</p>
