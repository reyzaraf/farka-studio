    <section id="home-page" class="page-section active">
        <div class="w-full h-[75vh] overflow-hidden relative">
            ...
            @elseif($isGdrive)
                <iframe id="hero-gdrive-video" class="absolute top-1/2 left-1/2 w-[300vw] h-[300vh] md:w-[150vw] md:h-[150vh] -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-0 transition-opacity duration-1000"
