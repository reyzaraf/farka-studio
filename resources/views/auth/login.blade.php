...
<html lang="en">
  <head>
    <title>Login | Admin Farka Studio</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
          ...
          <div class="card my-5">
            <div class="card-body">
              <div class="text-center">
                ...
                <h4 class="f-w-500 mb-4">Login to Admin Portal</h4>
              </div>
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <!-- Email Address -->
                <div class="mb-3">
                  <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Email Address" required autofocus autocomplete="username">
                  @error('email')
