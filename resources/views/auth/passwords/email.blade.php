...
<html lang="en">
  <head>
    <title>Reset Password | Admin Farka Studio</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
          ...
          <div class="card my-5">
            <div class="card-body">
              <div class="text-center">
                ...
                <h4 class="f-w-500 mb-4">Reset Password</h4>
              ...
              <form method="POST" action="{{ route('password.email') }}">
                ...
                <!-- Email Address -->
                <div class="mb-3">
                  <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Email Address" required autofocus autocomplete="email">
                  @error('email')
                ...
                <div class="d-flex mt-4 justify-content-center">
                  <a href="{{ route('login') }}" class="text-secondary"><i class="ti ti-arrow-left me-1"></i> Back to Login</a>
                </div>
              </form>
            </div>
          </div>
