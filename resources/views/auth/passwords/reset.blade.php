...
<html lang="en">
  <head>
    <title>Set New Password | Admin Farka Studio</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
          ...
          <div class="card my-5">
            <div class="card-body">
              <div class="text-center">
                ...
                <h4 class="f-w-500 mb-4">Set New Password</h4>
                <p class="text-muted mb-4">Please enter your email and your new password.</p>
              </div>
